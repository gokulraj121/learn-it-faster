...
export default function Landing() {
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <footer className="py-10 px-6 bg-black/40 border-t border-white/10">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-8">
            <Link to="/flashcard-generator" className="text-muted-foreground hover:text-white transition-colors">
              Flashcards
            </Link>
            <Link to="/file-converter" className="text-muted-foreground hover:text-white transition-colors">
              File Converter
            </Link>
            <Link to="/pdf-to-infographic" className="text-muted-foreground hover:text-white transition-colors">
              Infographics
            </Link>
            <Link to="/plans" className="text-muted-foreground hover:text-white transition-colors">
              Pricing
            </Link>
            <Link to="/auth" className="text-muted-foreground hover:text-white transition-colors">
              Sign In
            </Link>
          </div>
        </div>
